...
export class SignupTabPage {
  ...
  memberValidate(inputArray){
    let error="";
    let alphabets = /^[a-zA-Z-,]+(\s{0,1}[a-zA-Z-, ])*$/;
    let regex = /[0-9]|\./;
    ...
    if(inputArray.full_name){
      if(!inputArray.full_name.match(alphabets)){
        error+="<li>Please enter valid Full Name !";
      }
    }
    ...
    if(inputArray.mobile){
      if( !regex.test(inputArray.mobile) ) {
        error+="<li>Please enter valid Mobile Number !";
      }else if(inputArray.mobile.length !=10){
        error+="<li>Please enter valid Mobile Number !";
      }
    }
    if(inputArray.email==""){
    ...
    if(inputArray.dob){
      if(!pattern.test(inputArray.dob)){
        error+="<li>Please enter valid Date Of Birth !";
      }
    }
    if(inputArray.city==""){
    ...
    if(inputArray.city){
      if(!inputArray.city.match(alphabets)){
        error+="<li>Please enter valid City Name !";
      }
    }
    if(inputArray.state==""){
    ...
    if(inputArray.state){
      if(!inputArray.state.match(alphabets)){
        error+="<li>Please enter valid State Name !";
      }
    }
    ...
    if(dependantsValue){
      if((1 <= dependantsValue) && (dependantsValue < 7)){
        ...
        if(inputArray.full_name_1){
          if(!inputArray.full_name_1.match(alphabets)){
            error+="<li>Please enter valid Full Name for Member 1!";
          }
        }
        ...
        if(inputArray.mobile_no_1){
          if( !regex.test(inputArray.mobile_no_1) ) {
            error+="<li>Please enter valid Mobile Number for Member 1!";
          }else if(inputArray.mobile_no_1.length !=10){
            error+="<li>Please enter valid Mobile Number for Member 1!";
          }
        }
        ...
        if(inputArray.user_dob_1){
          if(!pattern.test(inputArray.user_dob_1)){
            error+="<li>Please enter valid Date Of Birth for Member 1!";
          }
        }
        ...
        if(inputArray.city_1){
          if(!inputArray.city_1.match(alphabets)){
            error+="<li>Please enter valid City for Member 1!";
          }
        }
        ...
        if(inputArray.state_1){
          if(!inputArray.state_1.match(alphabets)){
            error+="<li>Please enter valid State for Member 1!";
          }
        }
      ...
      if((2 <= dependantsValue) && (dependantsValue < 7)){
        ...
        if(inputArray.full_name_2){
          if(!inputArray.full_name_2.match(alphabets)){
            error+="<li>Please enter valid Full Name for Member 2!";
          }
        }
        ...
        if(inputArray.mobile_no_2){
          if( !regex.test(inputArray.mobile_no_2) ) {
            error+="<li>Please enter valid Mobile Number for Member 2!";
          }else if(inputArray.mobile_no_2.length !=10){
            error+="<li>Please enter valid Mobile Number for Member 2!";
          }
        }
        ...
        if(inputArray.user_dob_2){
          if(!pattern.test(inputArray.user_dob_2)){
            error+="<li>Please enter valid Date Of Birth for Member 2!";
          }
        }
        ...
        if(inputArray.city_2){
          if(!inputArray.city_2.match(alphabets)){
            error+="<li>Please enter valid City for Member 2!";
          }
        }
        ...
        if(inputArray.state_2){
          if(!inputArray.state_2.match(alphabets)){
            error+="<li>Please enter valid State for Member 2!";
          }
        }
      ...
      if((3 <= dependantsValue) && (dependantsValue < 7)){
        ...
        if(inputArray.full_name_3){
          if(!inputArray.full_name_3.match(alphabets)){
            error+="<li>Please enter valid Full Name for Member 3!";
          }
        }
        ...
        if(inputArray.mobile_no_3){
          if( !regex.test(inputArray.mobile_no_3) ) {
            error+="<li>Please enter valid Mobile Number for Member 3!";
          }else if(inputArray.mobile_no_3.length !=10){
            error+="<li>Please enter valid Mobile Number for Member 3!";
          }
        }
        ...
        if(inputArray.user_dob_3){
          if(!pattern.test(inputArray.user_dob_3)){
            error+="<li>Please enter valid Date Of Birth for Member 3!";
          }
        }
        ...
        if(inputArray.city_3){
          if(!inputArray.city_3.match(alphabets)){
            error+="<li>Please enter valid City for Member 3!";
          }
        }
        ...
        if(inputArray.state_3){
          if(!inputArray.state_3.match(alphabets)){
            error+="<li>Please enter valid State for Member 3!";
          }
        }
      ...
      if((4 <= dependantsValue) && (dependantsValue < 7)){
        ...
        if(inputArray.full_name_4){
          if(!inputArray.full_name_4.match(alphabets)){
            error+="<li>Please enter valid Full Name for Member 4!";
          }
        }
        ...
        if(inputArray.mobile_no_4){
          if( !regex.test(inputArray.mobile_no_4) ) {
            error+="<li>Please enter valid Mobile Number for Member 4!";
          }else if(inputArray.mobile_no_4.length !=10){
            error+="<li>Please enter valid Mobile Number for Member 4!";
          }
        }
        ...
        if(inputArray.user_dob_4){
          if(!pattern.test(inputArray.user_dob_4)){
            error+="<li>Please enter valid Date Of Birth for Member 4!";
          }
        }
        ...
        if(inputArray.city_4){
          if(!inputArray.city_4.match(alphabets)){
            error+="<li>Please enter valid City for Member 4!";
          }
        }
        ...
        if(inputArray.state_4){
          if(!inputArray.state_4.match(alphabets)){
            error+="<li>Please enter valid State for Member 4!";
          }
        }
      ...
      if((5 <= dependantsValue) && (dependantsValue < 7)){
        ...
        if(inputArray.full_name_5){
          if(!inputArray.full_name_5.match(alphabets)){
            error+="<li>Please enter valid Full Name for Member 5!";
          }
        }
        ...
        if(inputArray.mobile_no_5){
          if( !regex.test(inputArray.mobile_no_5) ) {
            error+="<li>Please enter valid Mobile Number for Member 5!";
          }else if(inputArray.mobile_no_5.length !=10){
            error+="<li>Please enter valid Mobile Number for Member 5!";
          }
        }
        ...
        if(inputArray.user_dob_5){
          if(!pattern.test(inputArray.user_dob_5)){
            error+="<li>Please enter valid Date Of Birth for Member 5!";
          }
        }
        ...
        if(inputArray.city_5){
          if(!inputArray.city_5.match(alphabets)){
            error+="<li>Please enter valid City for Member 5!";
          }
        }
        ...
        if(inputArray.state_5){
          if(!inputArray.state_5.match(alphabets)){
            error+="<li>Please enter valid State for Member 5!";
          }
        }
      ...
      if((6 <= dependantsValue) && (dependantsValue < 7)){
        ...
        if(inputArray.full_name_6){
          if(!inputArray.full_name_6.match(alphabets)){
            error+="<li>Please enter valid Full Name for Member 6!";
          }
        }
        ...
        if(inputArray.mobile_no_6){
          if( !regex.test(inputArray.mobile_no_6) ) {
            error+="<li>Please enter valid Mobile Number for Member 6!";
          }else if(inputArray.mobile_no_6.length !=10){
            error+="<li>Please enter valid Mobile Number for Member 6!";
          }
        }
        ...
        if(inputArray.user_dob_6){
          if(!pattern.test(inputArray.user_dob_6)){
            error+="<li>Please enter valid Date Of Birth for Member 6!";
          }
        }
        ...
        if(inputArray.city_6){
          if(!inputArray.city_6.match(alphabets)){
            error+="<li>Please enter valid City for Member 6!";
          }
        }
        ...
        if(inputArray.state_6){
          if(!inputArray.state_6.match(alphabets)){
            error+="<li>Please enter valid State for Member 6!";
          }
        }
  ...
  partnerValidate(inputArray){
    ...
    if(inputArray.brand_name){
      if(!inputArray.brand_name.match(alphabets)){
        error+="<li>Please enter valid Brand Name !";
      }
    }
    ...
    if(inputArray.company_name){
      if(!inputArray.company_name.match(alphabets)){
        error+="<li>Please enter valid Company Name !";
      }
    }
    ...
    if(inputArray.proprietor){
      if(!inputArray.proprietor.match(alphabets)){
        error+="<li>Please enter valid Owned By Name !";
      }
    }
    ...
    if(inputArray.outlet_no){
      if( !regex.test(inputArray.outlet_no) ) {
        error+="<li>Please enter valid Number of Outlet !";
      }
    }
    ...
    if(inputArray.head_city){
      if(!inputArray.head_city.match(alphabets)){
        error+="<li>Please enter valid City Name !";
      }
    }
    ...
    if(inputArray.head_state){
      if(!inputArray.head_state.match(alphabets)){
        error+="<li>Please enter valid State Name !";
      }
    }
    ...
    if(inputArray.head_mobile){
      if( !regex.test(inputArray.head_mobile) ) {
        error+="<li>Please enter valid Contact Number !";
      }
    }
    ...
    if(inputArray.customer_care){
      if( !regex.test(inputArray.customer_care) ) {
        error+="<li>Please enter valid Customer Care Number !";
      }
    }
    ...
    if(inputArray.contact_person){
      if(!inputArray.contact_person.match(alphabets)){
        error+="<li>Please enter valid Contact Person !";
      }
    }
    ...
    if(inputArray.designation){
      if(!inputArray.designation.match(alphabets)){
        error+="<li>Please enter valid Designation !";
      }
    }
    if(inputArray.email==""){
      error+="<li>Please enter Email id !";
