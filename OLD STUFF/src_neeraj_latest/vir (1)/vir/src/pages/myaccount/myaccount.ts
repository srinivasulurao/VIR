...
import { IonicPage, NavController, NavParams, ActionSheetController,ToastController,App,Platform,LoadingController,AlertController } from 'ionic-angular';
      ...
      buttons: [
        {
          ...
          handler: () => {
            ...
            //localStorage.clear();
            if(this.role_id==2){
              this.app.getRootNav().push(VendorPage,{ event : 'logoutEvent' });
            }else{
              this.app.getRootNav().push(Tab1Root,{ event : 'logoutEvent' });
            }
